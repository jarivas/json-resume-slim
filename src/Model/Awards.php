...
/**
 * @method static bool|Awards first(array<string, mixed> $columnValues)
 * @method static bool|Awards[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
