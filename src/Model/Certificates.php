...
/**
 * @method static bool|Certificates first(array<string, mixed> $columnValues)
 * @method static bool|Certificates[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
