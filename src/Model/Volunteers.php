...
/**
 * @method static bool|Volunteers first(array<string, mixed> $columnValues)
 * @method static bool|Volunteers[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
