...
/**
 * @method static bool|Languages first(array<string, mixed> $columnValues)
 * @method static bool|Languages[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
