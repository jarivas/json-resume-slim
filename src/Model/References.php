...
/**
 * @method static bool|References first(array<string, mixed> $columnValues)
 * @method static bool|References[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
