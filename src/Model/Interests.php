...
/**
 * @method static bool|Interests first(array<string, mixed> $columnValues)
 * @method static bool|Interests[] get(array<string, mixed> $columnValues = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
