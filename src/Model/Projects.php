...
/**
 * @method static bool|Projects first(array<string, mixed>|array<int, array> $criteria)
 * @method static bool|Projects last(array<string, mixed>|array<int, array> $criteria)
 * @method static bool|Projects[] get(array<string, mixed>|array<int, array> $criteria = [], int $offset = 0, int $limit = 100, array<string> $columns = []): bool|array
 */
